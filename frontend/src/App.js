  ...
  return (
    <PrimeReactProvider>
      ...
      >
        ...
        >
          <strong>Work in Progress:</strong> This dashboard is currently under active development. Evaluation results are not yet reliable. Final results will be published in the coming weeks.
        </div>
        <div
          style={{
            display: 'flex',
